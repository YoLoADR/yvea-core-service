...
export class Subscription {
  ...
  @Column({ name: 'trial_token_limit', type: 'int', default: 25000 }) // Valeur par défaut pour la limite d'essai
  trialTokenLimit: number;

  @Column({ name: 'monthly_token_limit', type: 'int', default: 150000 }) // Valeur par défaut pour la limite mensuelle
